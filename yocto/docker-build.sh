...
dtoverlay=imx219\n\
\"
IMAGE_INSTALL:append = \" qtmultimedia gstreamer1.0 gstreamer1.0-plugins-base gstreamer1.0-plugins-good gstreamer1.0-plugins-bad gstreamer1.0-plugins-ugly gstreamer1.0-libav v4l-utils ffmpeg libcamera libcamera-apps libcamera-gst\"
